...
class TestWeightSensor(unittest.TestCase):
    ...
    def test_run_with_stable_conditions(self):
        self.sensor._startUpHandler = 0  
        self.sensor.is_stable_tolerance = 25  
        self.sensor.acceptable_tolerance = 8 
        self.sensor.read_weight_buffer_size = 20 
        self.sensor.read_weight_buffer = [10, 12, 11, 9, 11]
        self.sensor.run()
        self.assertFalse(self.sensor._canread)
